...
import { Employee, EmployeeUpdateRequest } from '@/types/employee';
...
interface EditEmployeeModalProps {
  ...
  onClose: () => void;
  onUpdate: (id: number, data: EmployeeUpdateRequest) => Promise<void>;
}

export function EditEmployeeModal({ isOpen, employee, onClose, onUpdate }: EditEmployeeModalProps) {
  // State
