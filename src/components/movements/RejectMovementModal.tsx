...
export function RejectMovementModal({ isOpen, onClose, onConfirm }: RejectMovementModalProps) {
  ...
  const handleConfirm = async () => {
    setFieldError('');
    if (!remarks.trim()) {
      setFieldError('Please provide a reason for rejection.');
      return;
    }
    setIsLoading(true);
    setError('');
      ...
      <div className="w-full max-w-md rounded-xl bg-white shadow-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-6 py-5">
          ...
          <div className="mt-4">
            ...
            <textarea
              value={remarks}
              onChange={(e) => { setRemarks(e.target.value); setFieldError(''); }}
